...
#if 0
//program to check for obstacles and turn (with sensor)//
void zmain(void)
{
    //printf("You pressed the button and program started!\n");
    ...
    while (SW1_Read()==1){
        int dis = Ultra_GetDistance();
        if (dis < 10){
            motor_forward(0,0);
            motor_backward(100,600);
            motor_turn(0,255,280);
        }
